...
const Signup = () => {
  ...
  //   await axios.post("https://internshala-clone-xhqv.onrender.com/api/users/sync", {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="bg-white p-8 rounded-xl shadow-md w-full max-w-md">
        <h2 className="text-2xl font-bold text-center mb-6">{t("usersignup.title")}</h2>
        ...
        <div className="my-4 text-center text-gray-500">{t("usersignup.or")}</div>
